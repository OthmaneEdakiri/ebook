...
const Hero = () => {
  ...
  return (
    <div ref={home} style={{backgroundImage : `url(${heroBackground})`}} className="lg:h-[75vh] bg-no-repeat bg-cover bg-center relative hero">
      <div className="container h-full">
        <div className="flex flex-wrap lg:pt-0 pt-[150px] items-center h-full z-10 relative">
