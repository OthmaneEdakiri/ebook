...
const Author = () => {
  ...
  return (
    <div id="author" ref={author} className="author sm:py-[100px] py-[30px] relative overflow-hidden ">
      ...
      <div className="container">
        <div className="author-content flex flex-wrap gap-y-[30px] z-10 relative">
          <div className="lg:w-1/2 w-full">
            <div className="img-box sm:w-[350px] sm:h-[350px] w-[300px] h-[300px] rounded-full overflow-hidden mx-auto border-[#E9C46A] sm:border-[10px] border-[8px]">
              <img
